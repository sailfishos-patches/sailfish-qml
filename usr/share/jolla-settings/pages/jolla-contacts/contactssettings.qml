...
Page {
    ...
    SilicaFlickable {
        ...
        Column {
            ...
            PageHeader {
                //% "People"
                title:  qsTrId("contacts_settings-he-people")
            }
            ...
            Page {
                Column {
                    ...
                    Text {
                        ...
                        //% "Removes all contacts stored in the device.  This does not affect contacts synchronized from an external service, which should instead be removed by changing the settings for the relevant account."

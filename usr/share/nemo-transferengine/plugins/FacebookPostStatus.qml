...
ShareDialog {
    ...
    Column {
        ...
        DialogHeader {
            id: header
            //: Share to facebook dialog header
            //% "Share"
            acceptText: qsTrId("facebookshare-he-share_heading")
        }
    ...
    TextArea {
        id: textField
        visible: root.isLink
        //: Label indicating text field is used for entering facebook status
        //% "Status"
        label: qsTrId("facebookshare-la-status")
        //: Placeholder text for facebook status text area
        //% "My status"
        placeholderText: qsTrId("facebookshare-ph-my_status")
        width: parent.width

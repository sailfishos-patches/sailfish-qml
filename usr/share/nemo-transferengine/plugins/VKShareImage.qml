...
ShareDialog {
    ...
    SilicaFlickable {
        ...
        DialogHeader {
            ...
            //% "Share"
            acceptText: qsTrId("vk-share-he-share_heading")
        }
        ...
        Column {
            ...
            TextField {
                ...
                //: Image description
                //% "Description"
                label: qsTrId("vk-share-la-description")

                //: Placeholder text for image description
                //% "Add a description"
                placeholderText: qsTrId("vk-share-ph-description")
            ...
            ComboBox {
                ...
                //: Image scale
                //% "Scale image"
                label: qsTrId("vk-share-la-scale_image")

                menu: ContextMenu {
                    //: Image scale is 25%
                    //% "25 %"
                    MenuItem { text: qsTrId("vk-share-va-25_percent"); onClicked: root.scalePercent = 0.25 }
                    //: Image scale is 50%
                    //% "50 %"
                    MenuItem { text: qsTrId("vk-share-va-50_percent"); onClicked: root.scalePercent = 0.5 }
                    //: Image scale is 75%
                    //% "75 %"
                    MenuItem { text: qsTrId("vk-share-va-75_percent"); onClicked: root.scalePercent = 0.75  }
                    //: Image scale is original
                    //% "original"
                    MenuItem { text: qsTrId("vk-share-va-original"); onClicked: root.scalePercent = 1 }
                }
            }
            ...
            TextSwitch {
                ...
                //% "Include metadata"
                text: qsTrId("vk-share-me-include_metadata")
            ...
            Column {
                ...
                Column {
                    ...
                    Label {
                        width: settingsList.width - Theme.horizontalPageMargin - vkInfo.x
                ...
                Column {
                    Label {
                        ...
                        //% "Destination folder"
                        text: qsTrId("vk-share-la-destination_folder")
                    }
                    Label {
                        width: settingsList.width - Theme.horizontalPageMargin - vkInfo.x
                        color: Theme.secondaryHighlightColor
                        ...
                        text: qsTrId("vk-share-la-uploads-text").arg(aboutSettings.operatingSystemName)
                    }
                }
            }
        }

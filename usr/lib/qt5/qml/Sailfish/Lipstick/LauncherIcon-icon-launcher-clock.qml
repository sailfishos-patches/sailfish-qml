...
Item {
    ...
    property int seconds: time.getSeconds()
    property int minutes: time.getMinutes()
    property int hours: time.getHours()
    ...
    Item {
        ...
        rotation: visible ? hours * 15 + minutes / 10 : 0
    ...
    Item {
        ...
        Rectangle {
            ...
            anchors.bottomMargin: -radius
            width: 8
            height: (parent.height / 2 - outerCircle.border.width) / 3 * 2
            radius: width / 2
        }
    }

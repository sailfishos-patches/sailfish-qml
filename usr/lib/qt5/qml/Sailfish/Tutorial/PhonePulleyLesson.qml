...
Lesson {
    ...
    property int leftMargin: dummyIcon.width + Theme.paddingMedium*3 // one padding for dialer's missed call count
    ...
    Image {
        ...
        source: Qt.resolvedUrl("file:///usr/share/sailfish-tutorial/graphics/tutorial-phone-launcher.jpg")
    ...
    Image {
        ...
        source: Qt.resolvedUrl("file:///usr/share/sailfish-tutorial/graphics/tutorial-phone-app-background.jpg")
        width: parent.width
        opacity: 0.0
    }
            ...
            Repeater {
                ...
                delegate: Item {
                    ...
                    Image {
                        ...
                        source: model.type === 1
                                ? "image://theme/icon-s-incoming-call"
                                : model.type === 2
                                  ? "image://theme/icon-s-missed-call"
                                  : ""
                    }
